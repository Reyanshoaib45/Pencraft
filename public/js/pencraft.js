                    ...
                    let t = [],
                        ...
                        o = (a) => {
                            ...
                            let A = pe(a, {
                                ...
                                onSerialize: (g) => {
                                    Be(g, this.mirror) &&
                                        this.iframeManager.addIframe(g),
                                        Ge(g, this.mirror) &&
                ...
                (this.genAdds = (t, r) => {
                    if (this.mirror.hasNode(t)) {
                        ...
                        r &&
                            ...
                            (n = this.mirror.getId(r)),
                            n &&
                                n !== -1 &&
                                (this.movedMap[xt(this.mirror.getId(t), n)] =
                                    !0);
...
function zr({
    ...
    function d(A) {
        ...
        R === "radio" &&
            ...
            H &&
            t
                .querySelectorAll(`input[type="radio"][name="${f}"]`)
                .forEach((C) => {
                    C !== g &&
                        u(
                            C,
...
function Xt(e, t, r, n, o) {
    ...
    return (
        i.push(
            ...qt(t.WebGLRenderingContext.prototype, ce.WebGL, e, r, n, o, t)
        ),
...
var lr = () => {
    window.addEventListener(
        ...
        (e) => {
            ...
            ["Meta+z", "Meta+Backspace", "Meta+d"].includes(n) &&
                e.preventDefault(),
                n &&
                    _({
                        type: "KEYBIND",
        ...
        let t = e.getAttribute("data-lov-id") || "",
            ...
            a = Array.from(e.children)
                ...
                .filter(
                    (s, c, d) =>
                        c ===
                        d.findIndex((u) => q(u).filePath === q(s).filePath)
                )
                .map((s) => ({
    ...
    dr = () => {
      ...
      `),
            ...
            o = (f) => {
                if (!(!t.tooltip || !f))
                    try {
                        ...
                        if (
                            ((t.tooltip.style.maxWidth = `${v.MAX_TOOLTIP_WIDTH}px`),
                            I)
                        )
                            (t.tooltip.style.left =
                                v.FULL_WIDTH_TOOLTIP_OFFSET),
                                (t.tooltip.style.top =
                                    v.FULL_WIDTH_TOOLTIP_OFFSET);
                        else {
            ...
            i = (f) => {
                let C =
                    Math.abs(
                        f.getBoundingClientRect().width - window.innerWidth
                    ) < 5;
            ...
            s = r((f) => {
                ...
                t.hoveredElement &&
                    ...
                    (t.hoveredElement && b(q(t.hoveredElement)))?.forEach(
                        (M) => {
                            M.classList.contains("gpt-selected-element") ||
                                i(M);
                        }
                    ),
                    o(t.hoveredElement),
      ...
      `),
            ...
            b = (f) => {
                let C = `[data-lov-id="${f.filePath}:${f.lineNumber}:${
                        f.col || "0"
                    }"]`,
                ...
                try {
                    ...
                    switch (f.data.type) {
                        ...
                        case "UPDATE_SELECTED_ELEMENTS":
                            ...
                            document
                                .querySelectorAll(
                                    `[${v.SELECTED_ATTR}], [${v.HOVERED_ATTR}]`
                                )
                                .forEach((I) => {
                        ...
                        case "DUPLICATE_ELEMENT_REQUESTED": {
                            ...
                            b({ filePath: I.path, lineNumber: I.line }).forEach(
                                (T) => {
                                    let N = T.cloneNode(!0);
                        ...
                        case "HOVER_ELEMENT_REQUESTED": {
                            let { id: I } = f.data.payload;
                            document
                                .querySelectorAll(`[${v.HOVERED_ATTR}]`)
                                .forEach((T) => {
