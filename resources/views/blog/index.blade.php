...
<div class="bg-streamline-50 py-12">
    <div class="container mx-auto px-4 md:px-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            @auth
            <a href="{{ route('blog.create') }}" class="bg-streamline-600 hover:bg-streamline-700 text-white font-medium py-2 px-4 rounded-md transition-colors text-sm inline-flex items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse ($posts as $post)
                <article class="bg-white rounded-xl shadow-subtle overflow-hidden group animate-fade-in">
                    ...
                    <div class="relative aspect-[16/9] overflow-hidden">
                        ...
                        <span class="absolute top-4 left-4 bg-streamline-600 text-white text-xs font-medium px-2.5 py-1 rounded-full">
                            {{ $post->category }}
                        </span>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center pt-4 border-t border-gray-100">
                            @if ($post->author->profile_picture)
                                <img src="{{ asset('storage/' . $post->author->profile_picture) }}" alt="{{ $post->author->name }}" class="w-8 h-8 rounded-full mr-3 object-cover">
                            @else
                                <div class="w-8 h-8 rounded-full bg-streamline-100 text-streamline-600 flex items-center justify-center mr-3">
            ...
            @empty
                <div class="col-span-3 text-center py-12">
                    ...
                    @auth
                        <a href="{{ route('blog.create') }}" class="mt-4 inline-block bg-streamline-600 hover:bg-streamline-700 text-white font-medium py-2 px-4 rounded-md transition-colors text-sm">
