    ...
    <main class="container mx-auto px-4 py-16 max-w-7xl">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Find answers to your questions and learn how to get the most out of StreamLine
            </p>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">
                        Everything you need to know to start using StreamLine effectively.
                    </p>
                    <ul class="space-y-2">
                        <li>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">
                        Answers to the most commonly asked questions about StreamLine.
                    </p>
                    <ul class="space-y-2">
                        <li>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">
                        Step-by-step guides to help you master all StreamLine features.
                    </p>
                    <ul class="space-y-2">
                        <li>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mb-16">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mb-4">
                        Connect with other StreamLine users to share tips and get advice.
                    </p>
