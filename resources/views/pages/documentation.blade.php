...
<main class="container mx-auto px-4 py-16 max-w-7xl">
    <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Everything you need to know about using StreamLine effectively
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div class="lg:col-span-1 bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <ul class="space-y-3">
                ...
                <li><a href="#api-docs" class="text-streamline-600 hover:underline">API Documentation</a></li>
                <li><a href="#tutorials" class="text-streamline-600 hover:underline">Tutorials</a></li>
            ...
            <section id="getting-started" class="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="mb-6 border-b border-gray-200">
                    <nav class="flex -mb-px">
                        ...
                        <button class="py-2 px-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                            Your First Project
                        </button>
                        <button class="py-2 px-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                            Invite Your Team
                ...
                <div class="space-y-4">
                    ...
                    <ol class="list-decimal pl-5 space-y-3 text-gray-700">
                        <li>Sign up for an account on the StreamLine website.</li>
